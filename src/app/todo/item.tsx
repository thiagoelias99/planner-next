...
export default function TodoItem({ id, title, completed, date, handleEdit, ...rest }: TodoItemProps) {
  ...
  return (
    <Card className='w-full min-h-14 px-2 py-3 bg-card2 text-card2-foreground flex flex-row justify-start items-center gap-4 shadow-0 hover:bg-primary hover:text-primary-foreground transition-colors duration-300'>
